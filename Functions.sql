...
SELECT AddressExists('201', 'Main St', 'Springfield', 'StateA', 'USA', '62701') as DoesAddressExist;
...
/*
-- Demonstartion of PersonExists function for an existing person.
SELECT PersonExists(
        'Ethan',
        'Foster',
        '7234567890',
...
-- Demonstartion of PersonExists function for a non-existing person.
SELECT PersonExists(
        'Ether',
        'Fost',
        '7233567890',
